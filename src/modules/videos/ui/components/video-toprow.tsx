...
export const VideoTopRow = ({ video }: VideoTopRowProps) => {
    ...
    const expandedDate = useMemo(() => {
        return format(new Date(video.createdAt), 'dd MMMM yyyy');
    }, [video.createdAt]);
    ...
    return(
        <div className="flex flex-col gap-4 mt-4">
            ...
            <VideoDescription 
                ...
                compactDate={compactDate} expandedDate={expandedDate} 
                compactViews={compactViews} expandedViews={expandedViews} />
        </div>
    )
}